...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-8">
        ...
        <p class="mt-2 text-gray-600">Créez une nouvelle catégorie pour organiser vos annonces</p>
    </div>
        ...
        <form action="{{ route('categories.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input 
                    ...
                    id="slug" 
                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors bg-white/50 backdrop-blur-sm" 
                    placeholder="Ex: electronique, mobilier, vetements..."
                    required
                >
            ...
            <div class="flex items-center justify-between pt-6">
                ...
                <button 
                    type="submit" 
                    class="px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
                    Créer la catégorie
                </button>
            </div>
        </form>
